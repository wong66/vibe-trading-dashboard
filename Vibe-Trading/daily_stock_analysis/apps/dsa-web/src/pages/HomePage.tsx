      ...
      <div className="flex-1 flex flex-col min-h-0 min-w-0 max-w-full lg:max-w-6xl mx-auto w-full">
        ...
        <div className="flex min-w-0 flex-1 flex-nowrap items-center gap-1.5">
          <div className="flex min-w-0 flex-shrink-0 items-center gap-1.5">
            ...
            <div className="relative min-w-0 w-[260px] sm:w-[300px] md:w-[360px] lg:w-[420px]">
              <StockAutocomplete
                value={query}
                onChange={setQuery}
            ...
            {analysisSkills.length > 0 ? (
              <div ref={strategyMenuRef} className="relative flex-shrink-0">
                <button
                  ...
                  disabled={isAnalyzing}
                  className="home-surface-button flex h-7 flex-shrink-0 items-center gap-1 whitespace-nowrap rounded-md px-1.5 text-xs text-foreground disabled:cursor-not-allowed disabled:opacity-60 sm:max-w-[9rem]"
                >
                  <SlidersHorizontal className="h-3 w-3 flex-shrink-0" aria-hidden="true" />
          ...
          <div className="flex min-w-0 flex-1 flex-nowrap items-center gap-1 overflow-x-auto">
            <label className="flex h-7 flex-shrink-0 cursor-pointer items-center gap-1 whitespace-nowrap rounded-md border border-subtle bg-surface/60 px-1.5 text-xs text-secondary-text select-none transition-colors hover:border-subtle-hover hover:text-foreground">
              <input
                type="checkbox"
                checked={notify}
              ...
              <Button
                ...
                className="h-7 flex-1 flex-shrink-0 whitespace-nowrap md:flex-none rounded-md px-1.5 text-xs"
              >
              ...
              <button
                ...
                className="btn-primary flex h-7 flex-1 flex-shrink-0 items-center justify-center gap-1 whitespace-nowrap rounded-md px-1.5 text-xs md:flex-none"
              >
                {isAnalyzing ? (
                  <>
              ...
              {selectedReport ? (
                <>
                  {!isMarketReviewHistoryReport ? (
                    <>
                      <Button
                        ...
                        size="sm"
                        className="h-7 flex-shrink-0 whitespace-nowrap rounded-md px-1.5 text-xs"
                  ...
                  <Button
                    variant="home-action-ai"
                    size="sm"
                    className={isHistoryTrendOpen ? 'h-7 flex-shrink-0 whitespace-nowrap rounded-md border-primary/70 bg-primary/15 px-1.5 text-xs text-primary shadow-glow-cyan' : 'h-7 flex-shrink-0 whitespace-nowrap rounded-md px-1.5 text-xs'}
